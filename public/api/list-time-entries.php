...
$billingMonth = isset($_GET['billing_period_month']) ? trim((string) $_GET['billing_period_month']) : '';
$billingMonth = $billingMonth !== '' ? $billingMonth : null;
$limit = isset($_GET['limit']) ? (int) $_GET['limit'] : 50;
$offset = isset($_GET['offset']) ? (int) $_GET['offset'] : 0;

$apiKey = getApiKey();
$ip = $_SERVER['REMOTE_ADDR'] ?? 'unknown';
$result = runInvoicingApiListTimeEntries($apiKey, $ip, $engagementId, $billingMonth, $limit, $offset);
